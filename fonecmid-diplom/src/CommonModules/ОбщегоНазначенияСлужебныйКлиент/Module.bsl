...
//                            Определяет, какой Оклад является основным.
...
Процедура ЗавершитьРасчетПоказателей(Форма, ТекущаяКоманда, МинимальноеКоличество, РасчетныеПоказатели) 
	...
	Если РасчетныеПоказатели.Количество >= МинимальноеКоличество  Тогда 
		Форма.Оклад = Форма[ТекущийПоказатель];
		Элементы.Оклад.ФорматРедактирования = Элементы[ТекущийПоказатель].ФорматРедактирования;
	КонецЕсли;
