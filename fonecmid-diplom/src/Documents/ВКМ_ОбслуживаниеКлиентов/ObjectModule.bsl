...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ВыполняемыеРаботы.Количество() = 0 Тогда
...
Процедура ПриЗаписи(Отказ)
	...
	Если ЗначениеЗаполнено(СообщениеТелеграммБоту) Тогда 
		...
		Если Справочники.ВКМ_УведомленияТелеграммБоту.ДобавитьУведомление(СообщениеТелеграммБоту ) = Неопределено Тогда
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ВсегоЧасовКОплатеКлиенту = ВыполняемыеРаботы.Итог("ЧасыКОплатеКлиенту");
	СтавкаЧасаПоДоговору = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор,"BKM_СтоимостьЧаса");
	...
	Движение.ЧасовКОплате = ВыполняемыеРаботы.Итог("ФактическиПотраченоЧасов");
